...
public class Dungeon {
    ...
    /* Variables */
    int dungeonWidth, dungeonHeight;    //Size of the dungeonMatrix
    ...
    ArrayList<ArrayList<Tile>> dungeonMatrix;
     ...
     * @param dungeonHeight
     */
    Dungeon (int dungeonWidth, int dungeonHeight, int noOfRooms, int maxRoomSize, int diceRoll, int minimumCorridorLength) {
...
//        System.out.println ("Dungeon Creation took " + (System.nanoTime() - currentTime) / 1000000000 + " seconds");
    }
    ...
    */
     ...
     */
    void generateDoors(int maxDoorsPerRoom){
