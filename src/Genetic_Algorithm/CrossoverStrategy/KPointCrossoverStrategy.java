...
//TODO this is to be finished
@Deprecated
public class KPointCrossoverStrategy implements CrossoverStrategy {

    public static final String IMPLEMENTATION = "k_point";

    private int crossoverPoints;

    public KPointCrossoverStrategy(int crossoverPoints){
